...
const $$PoliticaCookies = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$PoliticaCookies;
  const entry = await getEntry("views", "politica-cookies");
  if (!entry) {
...
}, "D:/projetos/astro-news/src/pages/politica-cookies.astro", void 0);

const $$file = "D:/projetos/astro-news/src/pages/politica-cookies.astro";
